...
var doAction = function(actorlist) {
    ...
    if (actorlist[1] === "left" || actorlist[1] === "right" || actorlist[1] === "up" || actorlist[1] === "down" || actorlist[1] === "stay") {
        ...
        wasd = {
            w: new Entity(player.x+1,player.y-25,20,20,false,"img/controls/w.png"),
            a: new Entity(player.x-30,player.y+12.5,20,20,false,"img/controls/a.png"),
            s: new Entity(player.x+1,player.y+50,20,20,false,"img/controls/s.png"),
            d: new Entity(player.x+32,player.y+12.5,20,20,false,"img/controls/d.png"),
        };
    } else if (actorlist[1] === "mouseL") {
        //READY MOUSEL (UPDATED FROM FALSE)
        mouse_l = new Anim(player.x+5.5,player.y-35,18,30,false,"img/controls/leftmouse_1.png","img/controls/leftmouse_2.png",true);
    }
}
